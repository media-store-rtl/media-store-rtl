  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(link_default), {
        href: _ctx.route("cafe-net-admin.create"),
        ...
        if (props.webDesigns) {
          ...
          if (props.webDesigns.total > 0) {
            ...
            ssrRenderList(props.webDesigns.data, (product, index) => {
              ...
              _push(ssrRenderComponent(unref(link_default), {
                class: "dropdown-item",
                href: _ctx.route("cafe-net-admin.show", [product.id])
              }, {
                default: withCtx((_, _push2, _parent2, _scopeId) => {
                  if (_push2) {
                    _push2(` ویرایش`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Users/Admin/Cafe-Net/cafe-net-index.vue");
