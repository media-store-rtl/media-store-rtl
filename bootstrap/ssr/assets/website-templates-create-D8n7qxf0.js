...
const _sfc_main = {
  __name: "website-templates-create",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (_ctx.$page.props.auth.user) {
        ...
        _push(ssrRenderComponent(unref(link_default), {
          ...
          href: _ctx.route("website-templates.show", [props.products.slug])
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Guest/website-templates-create.vue");
