import { watch, computed, unref, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    computed(() => props.status === "verification-link-sent");
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(form).processing) {
        ...
        _push(`<span>ارسال ایمیل تایید</span>`);
      }
