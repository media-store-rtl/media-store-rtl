...
const _sfc_main = {
  ...
  props: { auth: Object, users: Object, tickets: Object, replies: Object, alert: Object },
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(props.replies, (ticket, index) => {
        ...
        if (ticket.user.id !== props.auth.user.id && props.tickets.status !== 3) {
        ...
        _push(`</div></div><div class="submenu text-a-r collapse"${ssrRenderAttr("id", "CollapseExample" + ticket.id)}><div class="card-body"><div class="mb-4"><label class="form-label">شرح<span class="text-danger me-1">*</span></label>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Users/Buyer/Support/support-reply.vue");
