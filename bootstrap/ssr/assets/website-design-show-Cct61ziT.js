...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div></div></div></div></div></div><div class="col-sm-4"><div class="card mb-50 mt-30"><div class="card-header text-bg-success"> سایر اطلاعات </div><div class="card-body"><div class="row"><div class="col-sm-4 d-flex justify-content-end"><select class="form-select"><option><span> عادی</span></option></select></div></div><ul class="list-group list-group-flush"><div class="list-group-item"><p>مجوز عادی : استفاده توسط یک شخص در یک پروژه </p></div><div class="list-group-item">`);
      if (props.companies) {
        _push(`<p><span class="material-symbols-outlined">check</span> خدمات تحویل شده مدت 60 روز گارانتی رفع خطا دارد </p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<p><span class="material-symbols-outlined">check</span> انجام فعالیت های طراحی مرتبط با موضوع و رعایت کیفیت و زمان بندی </p>`);
      if (props.companies) {
        _push(`<p><span class="material-symbols-outlined">check</span> انتخاب نام دامنه با نظر کارفرما </p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<p><span class="material-symbols-outlined">check</span> با قرارداد </p></div></ul></div></div><div class="mb-50 mb-50 mt-30"><div class="card mt-3 mb-3"><div class="card-header text-bg-success"> مشخصات خدمات: </div><div class="card-body"><div class="d-flex bd-highlight mt-3"><div class="bd-highlight"><h5 class="card-title">صفحات </h5></div><div class="ms-3 bd-highlight d-flex"><p class="card-text">${ssrInterpolate(props.tarahis.pages)},</p></div></div><div class="d-flex bd-highlight mt-3"><div class="bd-highlight"><h5 class="card-title">امکانات</h5></div><div class="ms-3 bd-highlight d-flex"><p class="card-text">${ssrInterpolate(props.tarahis.basic)},</p></div></div></div></div></div></div></div></div></main>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Guest/website-design-show.vue");
