  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(link_default), {
        href: _ctx.route("supportAdmin.create"),
      ...
      if (props.tickets && props.tickets.total > 0) {
        ...
        if (props.tickets.total > 0) {
          ...
          ssrRenderList(props.tickets.data, (ticket) => {
            ...
            _push(ssrRenderComponent(unref(link_default), {
              href: _ctx.route("supportAdmin.show", [ticket.id]),
              class: "btn btn-primary btn-sm rounded font-sm"
            }, {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
        ...
        if (props.tickets && props.tickets.total > 9) {
          _push(`<div class="pagination-area mb-20 mt-20"><nav aria-label="Page navigation example"><ul class="pagination justify-content-start"><li class="${ssrRenderClass([{ disabled: !props.tickets.prev_page_url || props.tickets.current_page === 1 }, "page-item"])}">`);
          _push(ssrRenderComponent(unref(link_default), {
            class: "page-link",
            href: props.tickets.prev_page_url && props.tickets.current_page > 1 ? props.tickets.prev_page_url : "",
            "preserve-scroll": "",
            "preserve-state": "",
            "aria-disabled": props.tickets.current_page === 1
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
          ...
          _push(`</li><li class="${ssrRenderClass([{ active: props.tickets.current_page === 1 }, "page-item"])}">`);
          _push(ssrRenderComponent(unref(link_default), {
            class: "page-link",
            href: getPageUrl(props.tickets.first_page_url, 1),
            "preserve-scroll": "",
            "preserve-state": ""
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          _push(`</li>`);
          if (props.tickets.current_page > 4) {
          ...
          ssrRenderList(5, (i) => {
            _push(`<!--[-->`);
            if (props.tickets.current_page - 3 + i > 1 && props.tickets.current_page - 3 + i < props.tickets.last_page) {
              _push(`<li class="${ssrRenderClass([{ active: props.tickets.current_page === props.tickets.current_page - 3 + i }, "page-item"])}">`);
              _push(ssrRenderComponent(unref(link_default), {
                class: "page-link",
                href: getPageUrl(props.tickets.path, props.tickets.current_page - 3 + i),
                "preserve-scroll": "",
                "preserve-state": ""
              }, {
                default: withCtx((_, _push2, _parent2, _scopeId) => {
                  if (_push2) {
                    _push2(`${ssrInterpolate(props.tickets.current_page - 3 + i)}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(props.tickets.current_page - 3 + i), 1)
                    ];
                  }
                }),
                _: 2
          ...
          _push(`<!--]-->`);
          if (props.tickets.current_page < props.tickets.last_page - 3) {
            _push(`<li class="page-item"><span class="page-link dot">...</span></li>`);
          } else {
            _push(`<!---->`);
          }
          if (props.tickets.last_page !== 1) {
            _push(`<li class="${ssrRenderClass([{ active: props.tickets.current_page === props.tickets.last_page }, "page-item"])}">`);
            _push(ssrRenderComponent(unref(link_default), {
              class: "page-link",
              href: getPageUrl(props.tickets.path, props.tickets.last_page),
              "preserve-scroll": "",
              "preserve-state": ""
            }, {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`${ssrInterpolate(props.tickets.last_page)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(props.tickets.last_page), 1)
                  ];
                }
              }),
              _: 1
          ...
          _push(`<li class="${ssrRenderClass([{ disabled: !props.tickets.next_page_url || props.tickets.current_page === props.tickets.last_page }, "page-item"])}">`);
          _push(ssrRenderComponent(unref(link_default), {
            class: "page-link",
            href: props.tickets.next_page_url && props.tickets.current_page < props.tickets.last_page ? props.tickets.next_page_url : "",
            "preserve-scroll": "",
            "preserve-state": "",
            "aria-disabled": props.tickets.current_page === props.tickets.last_page
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Users/Admin/Support/support-index.vue");
