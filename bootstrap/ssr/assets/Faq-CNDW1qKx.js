...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(head_default), { title: "سوالات متداول" }, null, _parent));
      ...
      ssrRenderList(props.pages, (page, index) => {
        _push(`<!--[-->${ssrInterpolate(page.title)} <p>${page.data ?? ""}</p><!--]-->`);
      });
      _push(`<!--]-->`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Guest/Faq.vue");
