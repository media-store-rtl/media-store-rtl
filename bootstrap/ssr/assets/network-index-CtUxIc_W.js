...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="col-lg-9"><section class="content-body p-xl-4"><form><div class="row"><div class="col-lg-8"><div class="row gx-3"><label class="form-label">دریافت وقایع از طریق:</label><div class="col-lg-3 mb-3"><label class="flex items-center">`);
      _push(ssrRenderComponent(_sfc_main$3, {
        name: "notification",
        checked: unref(form).notification,
        "onUpdate:checked": ($event) => unref(form).notification = $event
      }, null, _parent));
      _push(`<span class="ml-2 text-sm text-gray-600"> نتیفیکیشن</span></label></div><div class="col-lg-3 mb-3"><label class="flex items-center">`);
      _push(ssrRenderComponent(_sfc_main$3, {
        name: "email",
        checked: unref(form).email,
        "onUpdate:checked": ($event) => unref(form).email = $event
      }, null, _parent));
      _push(`<span class="ml-2 text-sm text-gray-600"> ایمیل</span></label></div></div></div></div><br></form><hr class="my-5"></section></div></div></div></div></section>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Users/Buyer/Network/network-index.vue");
