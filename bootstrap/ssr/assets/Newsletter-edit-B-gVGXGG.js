...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const props = __props;
    const form = useForm({
      id: props.newsletters.id,
      subject: props.newsletters.subject,
      text: props.newsletters.text,
      status: props.newsletters.status,
      route: props.newsletters.route,
      p_route: props.newsletters.p_route
    });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Users/Admin/Newsletter/Newsletter-edit.vue");
