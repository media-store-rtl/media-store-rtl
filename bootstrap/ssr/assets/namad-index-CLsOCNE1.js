  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(link_default), {
        href: _ctx.route("namadAdmin.create"),
      ...
      if (props.namads.total > 0) {
        ...
        if (props.namads.total > 0) {
          ...
          ssrRenderList(props.namads.data, (social, index) => {
            ...
            _push(ssrRenderComponent(unref(link_default), {
              class: "dropdown-item",
              href: _ctx.route("namadAdmin.show", [social.id])
            }, {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
            ...
            _push(ssrRenderComponent(unref(link_default), {
              ...
              href: _ctx.route("namadAdmin.destroy", [social.id]),
              method: "delete",
              as: "button",
        ...
        if (props.namads && props.namads.total > 9) {
          _push(`<div class="pagination-area mb-20 mt-20"><nav aria-label="Page navigation example"><ul class="pagination justify-content-start"><li class="${ssrRenderClass([{ disabled: !props.namads.prev_page_url || props.namads.current_page === 1 }, "page-item"])}">`);
          _push(ssrRenderComponent(unref(link_default), {
            class: "page-link",
            href: props.namads.prev_page_url && props.namads.current_page > 1 ? props.namads.prev_page_url : "",
            "preserve-scroll": "",
            "preserve-state": "",
            "aria-disabled": props.namads.current_page === 1
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
          ...
          _push(`</li><li class="${ssrRenderClass([{ active: props.namads.current_page === 1 }, "page-item"])}">`);
          _push(ssrRenderComponent(unref(link_default), {
            class: "page-link",
            href: getPageUrl(props.namads.first_page_url, 1),
            "preserve-scroll": "",
            "preserve-state": ""
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          _push(`</li>`);
          if (props.namads.current_page > 4) {
          ...
          ssrRenderList(5, (i) => {
            _push(`<!--[-->`);
            if (props.namads.current_page - 3 + i > 1 && props.namads.current_page - 3 + i < props.namads.last_page) {
              _push(`<li class="${ssrRenderClass([{ active: props.namads.current_page === props.namads.current_page - 3 + i }, "page-item"])}">`);
              _push(ssrRenderComponent(unref(link_default), {
                class: "page-link",
                href: getPageUrl(props.namads.path, props.namads.current_page - 3 + i),
                "preserve-scroll": "",
                "preserve-state": ""
              }, {
                default: withCtx((_, _push2, _parent2, _scopeId) => {
                  if (_push2) {
                    _push2(`${ssrInterpolate(props.namads.current_page - 3 + i)}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(props.namads.current_page - 3 + i), 1)
                    ];
                  }
                }),
                _: 2
          ...
          _push(`<!--]-->`);
          if (props.namads.current_page < props.namads.last_page - 3) {
            _push(`<li class="page-item"><span class="page-link dot">...</span></li>`);
          } else {
            _push(`<!---->`);
          }
          if (props.namads.last_page !== 1) {
            _push(`<li class="${ssrRenderClass([{ active: props.namads.current_page === props.namads.last_page }, "page-item"])}">`);
            _push(ssrRenderComponent(unref(link_default), {
              class: "page-link",
              href: getPageUrl(props.namads.path, props.namads.last_page),
              "preserve-scroll": "",
              "preserve-state": ""
            }, {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`${ssrInterpolate(props.namads.last_page)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(props.namads.last_page), 1)
                  ];
                }
              }),
              _: 1
          ...
          _push(`<li class="${ssrRenderClass([{ disabled: !props.namads.next_page_url || props.namads.current_page === props.namads.last_page }, "page-item"])}">`);
          _push(ssrRenderComponent(unref(link_default), {
            class: "page-link",
            href: props.namads.next_page_url && props.namads.current_page < props.namads.last_page ? props.namads.next_page_url : "",
            "preserve-scroll": "",
            "preserve-state": "",
            "aria-disabled": props.namads.current_page === props.namads.last_page
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Users/Admin/Public/namad-index.vue");
