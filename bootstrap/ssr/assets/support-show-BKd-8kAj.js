...
import _sfc_main$3 from "./support-reply-DqUh5-As.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><form><div class="card mb-4"><div class="card-body"><div class="card mb-4"><div class="col-sm-12 mt-3"><div class="d-flex me-2">`);
      ...
      if (props.tickets.user.id !== props.users.id && props.tickets.status !== 3) {
        _push(`<a${ssrRenderAttr("href", "#CollapseExample" + props.tickets.id)} class="reply me-1" data-bs-toggle="collapse" aria-expanded="false"${ssrRenderAttr("aria-controls", "CollapseExample" + props.tickets.id)}>پاسخ</a>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="submenu text-a-r collapse"${ssrRenderAttr("id", "CollapseExample" + props.tickets.id)}><div class="card-body"><div class="mb-4"><label class="form-label">پاسخ:<span class="text-danger me-1">*</span></label>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Users/Admin/Support/support-show.vue");
