      ...
      if (props.transactions && props.transactions.total > 0) {
        ...
        ssrRenderList(props.transactions.data, (transaction, index) => {
          ...
          _push(ssrRenderComponent(unref(link_default), {
            ...
            href: _ctx.route("paymentAdmin.edit", [transaction.id])
          }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Users/Admin/Payment/Payment-index.vue");
