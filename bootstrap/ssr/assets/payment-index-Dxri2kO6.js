  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (props.transactions.total > 0) {
        ...
        if (props.transactions.total > 0) {
          _push(`<div class="table table-hover"><thead><tr><th scope="col">شناسه</th><th scope="col">نوع تراکنش</th><th scope="col">مبلغ</th><th scope="col">تاریخ</th><th scope="col">وضعیت</th><th scope="col" class="text-center">عملیات</th></tr></thead><tbody><!--[-->`);
          ssrRenderList(props.transactions.data, (transaction, index) => {
            _push(`<tr><td>${ssrInterpolate(Number(transaction.id).toLocaleString("fa-IR"))}</td><td>${ssrInterpolate(transaction.transaction)}</td><td>${ssrInterpolate(Number(transaction.price).toLocaleString("fa-IR"))}</td><td>${ssrInterpolate(unref(moment)(transaction.created_at).locale("fa", unref(fa)).format("jYYYY/jM/jD HH:mm"))}</td><td>`);
            ...
            if (transaction.status == 0) {
              ...
              _push(ssrRenderComponent(unref(link_default), {
                class: "dropdown-item",
                href: _ctx.route("payment.edit", [transaction.id])
              }, {
              ...
              _push(ssrRenderComponent(unref(link_default), {
                ...
                href: _ctx.route("payment.destroy", [transaction.id]),
                method: "delete",
                as: "delete"
              }, {
                default: withCtx((_, _push2, _parent2, _scopeId) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Users/Buyer/Mali/payment-index.vue");
