...
const props = defineProps({
  canResetPassword: Boolean,status: String,cartCount: Number,companies: Object,alert: Object ,menus: Object,socials: Object,
    path: String,time:String,menu: Object,cart:Object,namads:Object
});
