    ...
    <main class="main">
            ...
            <div class="container mb-30">
                <div class="row">
                                            ...
                                            <p class="font-lg">
                                                <template v-for="(menu, index) in props.product.menus" :key="index">
                                                    <template v-for="(section, index) in menu.sections" :key="section.id">
                                                        <span href="" v-if="section.name == 'forms'">{{ menu.name + ' ' }}</span>
                                                    </template>
                                                </template>
                                            </p>
                                        </div>
                                ...
                                <div class="tab-style3">
                                    ...
                                    <div class="tab-content shop_info_tab entry-main-content">
                                        ...
                                        <div class="tab-pane fade" id="live">
                                            <Link :href="route('form.create', ['product']) + props.product.slug">
                                            پیش نمایش
                                            </Link>
                                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="card mb-50 mt-30" v-if="menus &&  menus[0].name == 'قالب'">
                        ...
                        <div class="mb-50 mb-50 mt-30">  
                            <div class="card mt-3 mb-3">
                                ...
                                <div class="card-body">
                                    <div class="d-flex bd-highlight" v-if="additional_facilities.length">
                                        <div class="bd-highlight">
                                            <h5 class="card-title">امکانات اضافی</h5>
                                        </div>
                                        <div class="ms-auto bd-highlight d-flex">
                                            <template v-for="menu,index in additional_facilities" :key="index">
                                                <p class="card-text" v-if="index < 1" >{{ menu.name}},</p>
                                                <p class="card-text" v-else >{{ menu.name}}</p>
                                            </template>
                                        </div>
                                    </div>
                                    <div class="d-flex bd-highlight" v-if="browsers.length">
                                        <div class="bd-highlight">
                                            <h5 class="card-title">پشتیبانی مرورگر</h5>
                                        </div>
                                        <div class="ms-auto bd-highlight d-flex">
                                            <template v-for="menu,index in browsers" :key="index">
                                                <p class="card-text" v-if="index < 1" >{{ menu.name}},</p>
                                                <p class="card-text" v-else >{{ menu.name}}</p>
                                            </template>
                                        </div>
                                    </div>
                                    <div v-else> مشخصات ندارد.</div>
                                </div>
                            </div>
                        </div>
                    </div>
