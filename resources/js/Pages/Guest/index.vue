...
.product-cart-wrap .product-img img{display:block;width:100%;height:100%;max-width:100%;max-height:100%;object-fit:cover!important;object-position:center;overflow:hidden;transition:transform .45s ease}
