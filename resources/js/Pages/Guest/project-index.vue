...
const submit = () => {
    if (form.name && form.lasst_name && form.email && form.tel  && form.group && form.type && form.text && form.title) {
...
const submitLogin = () => {
    ...
    if (form.group && form.type && form.text && form.title) {
        ...
        <div class="mb-30 container">
            <div class="row flex-row-reverse">
                <div class="col-lg-4-5">
                    ...
                    <!--End hero-->
                    <!--Products Tabs-->
                    <body id="project-intro" class="mce-content-body" contenteditable="true" spellcheck="false">
                        <p><strong>تعریف پروژه – سریع، آسان و قابل اعتماد</strong></p>
                        <p>هر پروژه‌ای که دارید، می‌توانید آن را به راحتی تعریف کنید. 
                        کافیست جزئیات پروژه، نیازمندی‌ها و زمان تحویل مورد نظر را وارد کنید. 
                        بعد از تعریف پروژه، فریلنسرهای متخصص می‌توانند برای آن پیشنهاد دهند و شما از میان آنها بهترین فرد را انتخاب می‌کنید.</p>

                        <p>📌 فرآیند پروژه:</p>
                        <ul>
                            <li><p>تعریف پروژه توسط کارفرما با جزئیات و الزامات مورد نظر</p></li>
                            <li><p>دریافت پیشنهادات فریلنسرها برای انجام پروژه</p></li>
                            <li><p>انتخاب فریلنسر مناسب برای انجام پروژه</p></li>
                            <li><p>پیاده‌سازی و تحویل پروژه توسط فریلنسر</p></li>
                            <li><p>تایید نهایی توسط کارفرما و آزاد شدن وجه فریلنسر</p></li>
                        </ul>

                        <p><strong>هدف ما این است که هر پروژه‌ای با شفافیت، راحتی و امنیت کامل انجام شود و کارفرما و فریلنسر هر دو تجربه‌ای حرفه‌ای و مطمئن داشته باشند.</strong></p>
                    </body>
                            ...
                            <ul class="nav nav-tabs links" id="myTab" role="tablist">
                                <li class="nav-item" >
                                    <Link
                                        ...
                                        :href="route('project.index','q')+'all'+'#result'"
                                    >
                                       کل
                                    </Link>
                                </li>
                                <li class="nav-item" >
                                    <Link
                                        ...
                                        :href="route('project.index','sort')+'DESC'+'#result'"
                                    >
                                       جدیدترین
                                    </Link>
                                </li>
                                <li class="nav-item" >
                                    <Link
                                        ...
                                        :href="route('project.index','sort')+'Bestselling'+'#result'"
                                    >
                                     بیشترین پیشنهاد
                                    </Link>
                                </li>
                                <li class="nav-item" >
                                    <Link
                                        ...
                                        :href="route('project.index','sort')+'open'+'#result'"
                                ...
                                <li class="nav-item" >
                                    <Link
                                        ...
                                        :href="route('project.index','sort')+'expensive'+'#result'"
                                    >
                                     بالا ترین مبلغ
                                    </Link>
                                </li>
                                <li class="nav-item" >
                                    <Link
                                        ...
                                        :href="route('project.index','sort')+'cheapest'+'#result'"
                                    >
                                        پایین ترین مبلغ
                                    </Link>
                                </li>
                                <li class="nav-item" >
                                    <Link
                                        ...
                                        :href="route('project.index','updated')+'updateDate'+'#result'"
                                    >
                                        بروزترین
                                    </Link>
                                </li>
                                    ...
                                    <div class="product-cart-wrap style-2" >
                                        <div class="product-img-action-wrap">
                                            <div class="product-img">
                                                <Link v-if="props.companies.image && props.companies.image.status == 4 || props.companies.image &&  props.companies.image.status == 5" :href="route('project.show',[result.slug])" >
                                        ...
                                        <div class="product-content-wrap">
                                            <div class="deals-countdown-wrap">
                                                <div v-if="result && result.status == 4 " class="deals-countdown"  :data-countdown="result.expired_at"></div>
                                                <div v-else class="deals-countdown"  data-countdown="2023-07-14 18:38:38.000000"></div>
                                            </div>
                                            <div class="deals-content">
                                                <div class="product-category" v-if="result.menus">
                                                    <template v-for="(menu, index) in result.menus" :key="index">
                                                        <template v-for="(section, index) in menu.sections" :key="section.id">
                                                            <a href="" v-if="section.name == 'projects'">{{ menu.name + ' ' }}</a>
                                                        </template>
                                                    </template>
                                                </div>
                                                <h2><Link :href="route('project.show',[result.slug])">{{result.title}}</Link></h2>
                                                ...
                                                <div class="product-card-bottom">
                                                    ...
                                                    <div class="add-cart">
                                                        <Link class="add" :href="route('project.show', [result.slug])" ><i class="mr-5"></i>جزییات </Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-12">
                                                        <div class="form-group">
                                                            <input v-model.lazy="form.title" type="text" class="form-control"
                                                                placeholder=" یک عنوان در ارتباط با پروژه بنویسید.عنوان پروژه برای جذب فریلنسر مهم است."
                                                                required="required">
                                                        </div>
                        ...
                        <ul v-for="(menu, index) in props.menus" :key="index">
                            <template v-for="(men, index) in menu.children" :key="index">
                                <li v-if="men.tarahis_count > 0">
                                    <Link :href="route('project.index', 'type') + men.id + '#result'">
                                ...
                                <div v-show="showMore" class="list-unstyled">
                                    ...
                                    <li v-if="me.tarahis_count > 0">
                                        <Link :href="route('project.index', 'category') + me.id + '#result'">
                                        {{ men.name + ' ' +me.name }}
                                        </Link>
