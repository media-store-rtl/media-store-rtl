        ...
        <main class="main">
            <div class="container mb-30">
                <div class="row">
                                    ...
                                    <div class="detail-info pr-30 pl-30">
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left" v-if="props.product.discount">
                                                ...
                                                <span>
                                                    ...
                                                    <span class="old-price font-md ml-15">{{ Number(props.product.price).toLocaleString('fa-IR') }}</span>
                                                </span>
                                            </div>
                                        ...
                                        <div class="detail-extralink mb-50">
                                            ...
                                            <div class="product-extra-link2">
                                                <button style="margin: 0 5px;" type="submit" class="button button-add-to-cart" @click.prevent="submitCart( props.product.id)"><i class="fi-rs-shopping-cart"></i>خرید</button>
                                        ...
                                        <div class="font-xs">
                                            <ul class="mr-50 float-start">
                                                <li class="mb-5">ورژن: 
                                                    <span class="text-brand" v-if="props.tarahis && props.tarahis.version">{{ props.tarahis.version }}</span>
                            ...
                            <div class="product-info">
                                <div class="tab-style3">
                                    <ul class="nav nav-tabs text-uppercase">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="live-tab" data-bs-toggle="tab" href="#live" >پیشنمایش</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="tab-content shop_info_tab entry-main-content">
                                        ...
                                        <div class="tab-pane fade" id="live">
                                            <Link :href="route('website-templates.create', ['product']) + props.product.slug">
                                            پیش نمایش
                                            </Link>
                                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="card mb-50 mt-30" v-if=" menus[0].name == 'قالب'">
                            <div class="card-header text-bg-success">
                               سایر اطلاعات 
                            </div>
                             <!-- v-if="props.auth && props.auth.user && props.auth.user.id ==  '1'" -->
                            
                            <div class="card-body" >
                               <div class="row ">
                                    <div class=" col-sm-2 d-flex justify-content-start">
                                        <label class="form-label">نوع مجوز:</label>
                                        
                                        
                                    </div>
                                <div class="col-sm-4 d-flex justify-content-end">
                                            <select  class="form-select" v-model="form.license">
                                                <option value="0" ><span> عادی</span></option>
                                                <!-- <option value="1"><span> ویژه</span></option>  -->
                                            </select>
                                        </div>
                                </div>
                                <ul class="list-group list-group-flush">
                                    <div class="list-group-item">
                                        <p v-if="form.license == 0">مجوز عادی : استفاده توسط یک شخص در یک پروژه </p>
                                        <!-- <p v-if="form.license == 1">مجوز ویژه : استفاده توسط یک شخص در تعداد نامحدود پروژه </p> -->
                                    </div>
                                <div class="list-group-item">
                        ...
                        <div class="mb-50 mb-50 mt-30">  
                            <div class="card mt-3 mb-3">
                                ...
                                <div class="card-body">
                                    <div class="d-flex bd-highlight mt-3" v-if="additional_facilities.length">
                                        <div class="bd-highlight">
                                            <h5 class="card-title">امکانات اضافی</h5>
                                        </div>
                                        <div class="bd-highlight d-flex ms-auto">
                                            <p class="" v-for="menu,index in additional_facilities" :key="index">
                                                <span class="card-text" v-if="index < 1" >{{ menu.name}},</span>
                                                <span class="card-text" v-else >{{ menu.name}},</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="d-flex bd-highlight mt-3" v-if="browsers.length">
                                        <div class="bd-highlight">
                                            <h5 class="card-title">پشتیبانی مرورگر</h5>
                                        </div>
                                        <div class="bd-highlight d-flex ms-auto">
                                            <p  class=""  v-for="menu,index in browsers" :key="index">
                                                <span class="card-text" v-if="index < 1" >{{ menu.name}},</span>
                                                <span class="card-text" v-else >{{ menu.name}},</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="mt-3" v-if="Object.keys(groupedPrerequisites).length">

                                        <h5 class="card-title">پیش نیازها</h5>

                                        <div v-for="(versions, title) in groupedPrerequisites" :key="title" class="d-flex">
                                            <p class="bd-highlight ms-auto">
                                                <strong>{{ title }} از</strong>
                                                <span class="">
                                                    <template v-for="(version,index) in versions" :key="index">
                                                        {{ version }}<span v-if="index < versions.length - 1"> تا </span>
                                                    </template>
                                                </span>
                                            </p >
                                        </div>
                                    ...
                                    <div class="mt-3" v-if="Object.keys(groupedTests).length">
                                        <h5 class="card-title">تست شده</h5>
                                        <div v-for="(tests, title) in groupedTests" :key="title" class="d-flex">
                                            <p class="bd-highlight ms-auto">
                                                <strong>{{ title }} از</strong>
                                                <span class="">
                                                    <template v-for="(test,index) in tests" :key="index">
                                                        {{ test }}<span v-if="index < tests.length - 1"> تا </span>
                                                    </template>
                                                </span>
                                            </p>
                                        </div>
