            ...
            <div class="row flex-row-reverse">
                <div class="col-lg-12">
                    ...
                    <body id="tinymce" class="mce-content-body " data-id="tiny-vue_23772426321754249352926" aria-label="Rich Text Area" contenteditable="true" spellcheck="false">
                        ...
                        <p data-start="349" data-end="612">اگر دنبال راهی سریع‌تر و مقرون‌به‌صرفه برای راه‌اندازی سایت هستید، قالب‌های آماده یک گزینه عالی هستن.
                            <br data-start="450" data-end="453">ما مجموعه‌ای از قالب‌های حرفه‌ای، ریسپانسیو و بهینه‌شده برای سئو آماده کردیم که می‌تونید با کمترین هزینه تهیه کنید و در کوتاه‌ترین زمان سایتتون رو راه بندازید.</p>
                            ...
                            <ul class="nav nav-tabs links" id="myTab" role="tablist">
                                <li class="nav-item" >
                                    <Link
                                        ...
                                        :href="route('form.index','q')+'all'+'#result'"
                                    >
                                       کل
                                    </Link>
                                </li>
                                <li class="nav-item" >
                                    <Link
                                        ...
                                        :href="route('form.index','sort')+'DESC'+'#result'"
                                    >
                                       جدیدترین
                                    </Link>
                                </li>
                                <li class="nav-item" >
                                    <Link
                                        ...
                                        :href="route('form.index','sort')+'Bestselling'+'#result'"
                                    >
                                        پرفرش ترین
                                    </Link>
                                </li>
                                <li class="nav-item" >
                                    <Link
                                        ...
                                        :href="route('form.index','sort')+'Discount'+'#result'"
                                ...
                                <li class="nav-item" >
                                    <Link
                                        ...
                                        :href="route('form.index','sort')+'expensive'+'#result'"
                                    >
                                        گران ترین
                                    </Link>
                                </li>
                                <li class="nav-item" >
                                    <Link
                                        ...
                                        :href="route('form.index','sort')+'cheapest'+'#result'"
                                    >
                                        ارزان ترین
                                    </Link>
                                </li>
                                <li class="nav-item" >
                                    <Link
                                        ...
                                        :href="route('form.index','updated')+'updateDate'+'#result'"
                                    >
                                        بروزترین
                                    </Link>
                                </li>
                                        ...
                                        <div class="product-cart-wrap mb-30">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <Link
                                                        :href="route('form.show', [result.slug])"
                                            ...
                                            <div class="product-content-wrap">
                                                <div class="product-category">
                                                    <template v-for="(menu, index) in result.menus" :key="index">
                                                        <template v-for="(section, index) in menu.sections" :key="section.id">
                                                            <a href="" v-if="section.name == 'forms'">{{ menu.name + ' ' }}</a>
                                                        </template>
                                                    </template>
                                                </div>
                                                <h2>
                                                ...
                                                <div class="product-card-bottom">
                                                    ...
                                                    <div class="add-cart">
                                                        <Link class="add" :href="route('form.show', [result.slug])"
                                                    ...
                                                    <div class="product-cart-wrap " v-for="result in discounts" :key="result.id">
                                                        <div class="product-img-action-wrap">
                                                            <div class="product-img">
                                                                <Link :href="route('form.show', [result.discountable.slug])">
                                                                    <img
                                                                        class="h-250"
                                                                        v-if="
                                                            ...
                                                            <div class="deals-content">
                                                                ...
                                                                <div class="product-card-bottom">
                                                                    ...
                                                                    <div class="add-cart">
                                                                        <Link
                                                                            class="add"
                                                                            :href="route('form.show', [result.discountable.slug])"
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up" v-for="(result,index) in props.orders " :key="index">
                                ...
                                <div class="col-md-8 mb-0">
                                    <h6>
                                        <Link :href="route('form.show', [result.product.slug])" >{{ result.product.name }}</Link>
                                    </h6>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-md-0" v-if="props.favorites.length > 0">
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up" v-for="result,index in props.favorites" :key="index">
                                ...
                                <div class="col-md-8 mb-0">
                                    <h6>
                                        <Link :href="route('form.show', [result.favoritable.slug])">{{ result.favoritable.name }}</Link>
                                    </h6>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-lg-block" v-if="props.resultsNew.length">
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up"  v-for="(result, index) in props.resultsNew" :key="index">
                                ...
                                <div class="col-md-8 mb-0">
                                    <h6>
                                        <Link :href="route('form.show', [result.slug])">{{ result.name }}</Link>
                                    </h6>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
