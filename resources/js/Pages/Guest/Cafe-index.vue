...
const submit = () => {
    if (form.name && form.lasst_name && form.email && form.tel  && form.group && form.type && form.text && form.title && form.entekhab) {
        ...
        if (props.companies && props.companies.name == form.entekhab) {
                form.post(route('cafe-net.store'))
            }
            else
            {
                form.post(route('cafe-net.store'))
            ...
            <div class="row flex-row-reverse">
                <div class="col-lg-12">
                    ...
                    <body id="tinymce" class="mce-content-body" contenteditable="true" spellcheck="false">
                        <p><strong>خدمات آنلاین اینترنت – سریع، اقتصادی و قابل اعتماد</strong></p>
                        <p>اگر دنبال راهی سریع‌تر و مقرون‌به‌صرفه برای خدمات آنلاین اینترنت هستید، استفاده از خدمات آنلاین اینترنت یک گزینه عالی هستن.<br>
                        ما مجموعه‌ای از  خدمات آنلاین اینترنت آماده کردیم که می‌توانید و در کوتاه‌ترین زمان ممکن کار های اینترنتی خود رو به ما بسپارید.</p>

                        <p>📦 خدمات مناسب برای:</p>
                        <ul>
                            <li><p>ثبت نام</p></li>
                        </ul>

                        <p><strong>هدف ما اینه که شما سریع‌تر و راحت‌تر به صورت دور کار به کارای اینترنتی خودتون بپردازید.</strong></p>
                    </body>

                        <!--End Deals-->
                    <section class="product-tabs section-padding position-relative" v-if="props.results && props.results.total > 0">
                        <div class="section-title style-2">
                            <h3>خدمات آنلاین اینترنت</h3>
                                        ...
                                        <div class="product-cart-wrap mb-30">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <Link
                                                        :href="route('cafe-net.show', [result.slug])"
                                            ...
                                            <div class="product-content-wrap">
                                                <div class="product-category">
                                                    <template v-for="(menu, index) in result.menus" :key="index">
                                                        <template v-for="(section, index) in menu.sections" :key="section.id">
                                                            <a href="" v-if="section.name == 'cafes'">{{ menu.name + ' ' }}</a>
                                                        </template>
                                                    </template>
                                                </div>
                                                <h2>
                                                    <Link :href="route('cafe-net.show', [result.slug])">{{ result.group.name + ' ' + result.type.name + ' ' + result.category.name + ' ' + result.name }}</Link>
                                                </h2>
                                                <div>
                                                ...
                                                <div>
                                                    <span class="font-small text-muted"
                                                        >{{ result.rouzekari }} روز کاری</span
                                                    >
                                                </div>
                                                ...
                                                <div class="product-card-bottom">
                                                    ...
                                                    <div class="add-cart">
                                                        <Link class="add" :href="route('cafe-net.show', [result.slug])"
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up" v-for="(result,index) in props.orders " :key="index">
                                ...
                                <div class="col-md-8 mb-0">
                                    <h6>
                                        <Link :href="route('cafe-net.show', [result.product.slug])" >{{ result.product.name }}</Link>
                                    </h6>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-md-0" v-if="props.favorites && props.favorites.length > 0">
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up" v-for="result,index in props.favorites" :key="index">
                                ...
                                <div class="col-md-8 mb-0">
                                    <h6>
                                        <Link :href="route('cafe-net.show', [result.favoritable.slug])">{{ result.favoritable.name }}</Link>
                                    </h6>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-lg-block" v-if="props.resultsNew && props.resultsNew.length">
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up"  v-for="(result, index) in props.resultsNew" :key="index">
                                <figure class="col-md-4 mb-0">
                                    <Link :href="route('cafe-net.show', [result.slug])">
                                        <img v-if="result.image" :src="$page.props.ziggy.url + '/storage/' + result.image.url" alt="" />
                                    </Link>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                                        <Link :href="route('cafe-net.show', [result.slug])">{{ result.name }}</Link>
                                    </h6>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
