    ...
    <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
      ...
      <div class="flex lg:hidden">
        <button type="button" command="show-modal" commandfor="mobile-menu" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700">
          <span class="sr-only">منوی اصلی را باز کنید</span>
      ...
      <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        <Link :href="route('login')" class="text-sm/6 font-semibold text-gray-900">ورود <span aria-hidden="true"></span></Link>
      </div>
    </nav>
    <el-dialog>
        ...
        <div tabindex="0" class="fixed inset-0 focus:outline-none">
          <el-dialog-panel class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white p-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div class="flex items-center justify-between">
              <a href="#" class="-m-1.5 p-1.5">
                <span class="sr-only">نرم افزار حسابداری</span>
                <img src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=600" alt="" class="h-8 w-auto" />
              </a>
            ...
            <div class="mt-6 flow-root">
              <div class="-my-6 divide-y divide-gray-500/10">
                ...
                <div class="py-6">
                  <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">ورود</a>
                </div>
              </div>
            </div>
          </el-dialog-panel>
  ...
  <div class="relative isolate px-6 pt-14 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      ...
      <div class="text-center">
        <h1 class="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">نرم افزار حسابداری تحت وب</h1>
        <p class="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">لطفا برای استفاده از خدمات وارد حساب کاربری خود شوید.</p>
