...
<template v-cloak>
    <Seo :title="'ثبت سفارش قالب سایت | فروشگاه مدیا'" :description="'ثبت سفارش قالب سایت از فروشگاه مدیا.'" :noIndex="true" />
    <head>
            ...
            <div class="container">
                ...
                <div v-if="$page.props.auth.user" class="collapse navbar-collapse main-menu" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                             <Link class="nav-link page-scroll"  :href="route('website-templates.show',[props.products.slug])">خرید و دانلود</Link>
                        </li>
