...
const props = defineProps({
    auth:Object,pages:Object,alert:Object, cart:Object,namads:Object,socials: Object,path: String,
    companies:Object,menus: Object,menu: Object
...
<template >
    <Seo :title="'حریم خصوصی | فروشگاه مدیا'" :description="'سیاست حریم خصوصی و نحوه استفاده و حفاظت از اطلاعات کاربران در فروشگاه مدیا.'" :noIndex="false" />
