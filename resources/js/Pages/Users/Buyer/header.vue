        ...
        <nav>
            <ul class="menu-aside">
                ...
                <li class="menu-item has-submenu" :class="[$page.url == '/users/order' ? 'active' : '',
                    ...
                    <div class="submenu text-a-l collapse " id="multiCollapseExample1">
                        ...
                        <Link :href="route('website-design.index', 'q') + 'all'">طراحی وبسایت</Link>
                        <Link :class="[$page.url == '/users/tarahi' ? 'active' : '']" :href="route('tarahi.index')">پروژه های من</Link>
                    </div>
                </li>
                <li class="menu-item has-submenu" :class="[$page.url == '/users/support' ? 'active' : '',
                    ...
                    <a class="menu-link" >
                        <i class="icon material-icons ">
                            <img :src="$page.props.ziggy.url+'/img/headset.png'" />
                        </i>
            ...
            <ul class="menu-aside" v-for="role,index in props.users.roles" :key="index">
                ...
                <li class="menu-item has-submenu" v-if="role.id == 1" :class="[$page.url == '/users/product' ? 'active' : '',
                    ...
                    <a class="menu-link" >
                        <i class="icon material-icons">
                            <img :src="$page.props.ziggy.url+'/img/add-shopping-cart.png'" />
                        </i>
            ...
            <ul class="menu-aside" v-for="role,index in props.users.roles" :key="index">
                ...
                <li class="menu-item has-submenu" v-if="role.id == 2" :class="[$page.url == '/users/tarahiDesigner' ? 'active' : '']">
                    <a class="menu-link">
                        <i class="icon material-icons ">
                            <img :src="$page.props.ziggy.url+'/img/laptop-settings.png'" />
                        </i>
                        <span class="text">پروژه</span>
                    </a>
                    <div class="submenu text-a-l collapse " id="multiCollapseExample3">
                        <Link :class="[$page.url == '/users/tarahiDesigner' ? 'active' : '']" :href="route('tarahiDesigner.index')">لیست پروژه
                        </Link>
                    </div>
                </li>
            ...
            <ul class="menu-aside" v-for="role,index in props.users.roles" :key="index">
                ...
                <li class="menu-item has-submenu" v-if="role.id == 3"  :class="[$page.url == '/users/paymentAdmin' ? 'active' : '',
                    ...
                    <a class="menu-link" >
                        <i class="icon material-icons">
                            <img :src="$page.props.ziggy.url+'/img/external-financial-global-crisis-phatplus-lineal-phatplus.png'" />
                        </i>
                ...
                <li class="menu-item has-submenu" v-if="role.id == 3"  :class="[$page.url == '/users/commentAdmin' ? 'active' : '',
                    ...
                    <a class="menu-link" >
                        <i class="icon material-icons">
                            <img :src="$page.props.ziggy.url+'/img/delivery-settings.png'" />
                        </i>
                ...
                <li class="menu-item has-submenu" v-if="role.id == 3"  :class="[$page.url == '/users/cafe-net-admin' ? 'active' : '']">
                    <a class="menu-link" >
                        <i class="icon material-icons">
                            <img :src="$page.props.ziggy.url+'/img/laptop-settings.png'" />
                        </i>
                        <span class="text">مدیریت کافی نت</span>
                    </a>
                    <div class="submenu text-a-l  collapse multi-collapse" id="multiCollapseExample20">
                        <Link :class="[$page.url == '/users/cafe-net-admin' ? 'active' : '']" :href="route('cafe-net-admin.index')">کافی نت</Link>
                    </div>
                </li>
                <li class="menu-item has-submenu" v-if="role.id == 3"  :class="[$page.url == '/users/tarahiAdmin' ? 'active' : '',
                    $page.url == '/users/contractAdmin' ? 'active' : ''
                ]">
                    <a class="menu-link" >
                        <i class="icon material-icons">
                            <img :src="$page.props.ziggy.url+'/img/product.png'" />
                        </i>
                        <span class="text">مدیریت پروژه و قرارداد</span>
                    </a>
                    <div class="submenu text-a-l  collapse multi-collapse" id="multiCollapseExample13">
                        ...
                        پروژه</Link>
                        <Link :class="[$page.url == '/users/contractAdmin' ? 'active' : '']" :href="route('contractAdmin.index')">لیست
                        قرارداد</Link>
                    </div>
                </li>
                <li class="menu-item has-submenu" v-if="role.id == 3"  :class="[$page.url == '/users/blogAdmin' ? 'active' : '']">
                    <a class="menu-link" >
                        <i class="icon material-icons">
                            <img :src="$page.props.ziggy.url+'/img/test-passed--v1.png'" />
                        </i>
                ...
                <li class="menu-item has-submenu" v-if="role.id == 3"  :class="[$page.url == '/users/profileAdmin' ? 'active' : '',
                    ...
                    <a class="menu-link" >
                        <i class="icon material-icons">
                            <img :src="$page.props.ziggy.url+'/img/conference-background-selected.png'" />
                        </i>
            ...
            <ul class="menu-aside" v-for="role,index in props.users.roles" :key="index">
                ...
                <li class="menu-item has-submenu" v-if="role.id == 4" :class="[$page.url == '/users/orderModir' ? 'active' : '']">
                    <a class="menu-link" >
                        <i class="icon material-icons">
                            <img :src="$page.props.ziggy.url+'/img/area-chart--v1.png'" />
                        </i>
                ...
                <li class="menu-item has-submenu" v-if="role.id == 4" :class="[$page.url == '/users/dataBase' ? 'active' : '']">
                    <a class="menu-link" >
                        <i class="icon material-icons md-settings"></i>
                        <span class="text">عمومی</span>
                    </a>
                    <div class="submenu text-a-l collapse multi-collapse" id="multiCollapseExample21">
                        <Link :class="[$page.url == '/users/dataBase' ? 'active' : '',]" :href="route('dataBase.index')">
                        دیتابیس
                        </Link>
    ...
    <main class="main-wrap ">
        <header class="main-header navbar rtl">
            ...
            <div class="col-nav">
                ...
                <ul class="nav">
                    <li class="nav-item">
                        <Link class="nav-link btn-icon" :href="route('dashboard.index')">
