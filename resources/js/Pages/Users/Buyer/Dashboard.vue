    ...
    <Header :cart="props.cart"  :roles="props.roles" :alert="props.alert" :users="props.users" :wallet="props.wallet"
        ...
        <main class="main-wrap rtl">
            <section class="content-main ">
                ...
                <div class="col-lg-12" v-if="props.notifications.length > 0">
                    <div class="card mb-4">
                    <article class="card-body">
                        ...
                        <li
                            ...
                            :key="notification.id"
                            class="event-list"
                            :class="{ active: notification === props.notifications[0] }"
                        >
                            <div class="event-timeline-dot">
                            <i
                                class="material-icons md-play_circle_outline font-xxl"
                                :class="{ 'animation-fade-right': notification === props.notifications[0] }"
                            ></i>
                            </div>
                            <div class="media">
                            <div class="me-3">
