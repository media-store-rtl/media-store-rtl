                        ...
                        <div class="invoice-inner">
                            <div class="invoice-info" id="invoice_wrapper">
                                <div class="invoice-header">
                                    <div class="invoice-icon">
                                        <img :src="$page.props.ziggy.url+'/assets/imgs/theme/icons/icon-invoice.svg'" class="img-fluid" alt="">
                                    </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            <div class="text" v-if="props.companies">{{ props.companies.name_show }}<br />
                                                <abbr title="Phone">تلفن:</abbr> {{props.companies.phone}}<br />
                                                <abbr title="Phone">پست الکترونیک:</abbr> {{props.companies.email}}<br />
                                            </div>
                                        </div>
                                        <div class="col-md-6 text-end">
                                            <strong v-if="props.orders.user.profile.gender == 'آقا'">{{props.orders.user.profile.gender}} </strong>
                                            <strong v-else-if="props.orders.user.profile.gender == 'خانم'"> {{props.orders.user.profile.gender}} </strong>
                                        ...
                                        <table class="table table-striped invoice-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">{{Number(props.orders.price).toLocaleString("fa-IR")}} ریال</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="7" class="text-end f-w-600">تخفیف</td>
                                                    <td class="text-right">{{ Number(props.orders.discount).toLocaleString("fa-IR") }} ریال</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="7" class="text-end f-w-600">بن تخفیف</td>
                                                    <td class="text-right">{{ Number(props.orders.coupon).toLocaleString("fa-IR") }} ریال</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="7" class="text-end f-w-600">جمع کل</td>
                                                    <td class="text-right f-w-600">{{ Number(props.orders.col).toLocaleString("fa-IR") }} ریال</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="7" class="text-end f-w-600"> پرداخت شده</td>
                                                    <td class="text-right f-w-600">{{ Number(props.orders.payment).toLocaleString("fa-IR") }} ریال</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="7" class="text-end f-w-600">مانده</td>
                                                    <td class="text-right f-w-600">{{ Number(props.orders.col-props.orders.payment).toLocaleString("fa-IR") }} ریال</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                            ...
                            <div class="invoice-btn-section clearfix d-print-none">
                                <a href="javascript:window.print()" class="btn btn-lg btn-custom btn-print hover-up">
                                    <img :src="$page.props.ziggy.url+'/assets/imgs/theme/icons/icon-print.svg'" alt="" /> چاپ
                                </a>
                                <a id="invoice_download_btn" class="btn btn-lg btn-custom btn-download hover-up">
                                    <img :src="$page.props.ziggy.url+'/assets/imgs/theme/icons/icon-download.svg'" alt="" /> دانلود
                                </a>
                            </div>
                        </div>
                    </div>
