    ...
    props.socials.data.forEach(element => {
        ...
        if(social.id == element.title )
        {
            ...
            if (element.link) {
                ...
                socials.value.push({link : element.link.user_id == props.users.id ? element.link.link : null ,
                    id: element.link.linkable_id ? element.link.id :null,
                social_id:element.link.linkable_id ,name:social.name,
                                ...
                                <section class="content-body p-xl-4">
                                    <form>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="row gx-3" >
                                                    <template v-for="socia,index in socials" :key="index">
                                                        ...
                                                        <div class="class row">
                                                            ...
                                                            <div class="class col mb-3" v-if="socia.id && socia.link && socia.user_id == props.auth.user.id">
                                                            ...
                                                            <div class="class col mb-3" v-if="socia.id && socia.link && socia.status">
