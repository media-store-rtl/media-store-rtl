...
const form =  useForm({
    ...
    file: props.users?.identity?.file?.url ?? null,
                                        ...
                                        <div class="row">
                                            ...
                                            <aside class="col-lg-4">
                                                <figure class="text-lg-center">
                                                    ...
                                                    <img v-if="props.users && props.users.identity && props.users.identity.file" :src="$page.props.ziggy.url+'/storage/'+ props.users.identity.file.url" alt="national code Photo" />
