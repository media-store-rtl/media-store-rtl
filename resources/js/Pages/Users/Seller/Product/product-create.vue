...
const form = useForm({
    ...
    test:[] , sub_test:{},tag:null,slug:null,keywords:null
});
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row gx-2">
                                        ...
                                        <div class="col-lg-6" v-if="form.test" v-for="tes,index in form.test" :key="index" >
                                            <label class="form-label">نسخه تست محصول ({{tes.name}})</label>
                                            <VueMultiselect
                                    ...
                                    <div class="row gx-2">
                                        <label class="form-label">تگ سئو: طول کارکتر بین ۱۲۰ تا ۱۶۰ کاراکتر و شامل کلمه کلیدی اصلی</label>
