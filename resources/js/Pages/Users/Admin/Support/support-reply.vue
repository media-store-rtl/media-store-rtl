...
<template>
        ...
        <div class="submenu text-a-r collapse " :id="'CollapseExample'+ticket.id">
            <div class="card-body">
                <div class="mb-4">
                    ...
                    <Editor  v-model="form.text" placeholder="اینجا تایپ کنید" />
                </div>
            </div>
            <div class="card-body" >
            ...
            <button  @click.prevent="submit(ticket.id)" :class="{ 'opacity-25': form.processing }" :disabled="form.processing" class="btn btn-primary me-4">
    ...
    <hr>
    <TicketReply  :tickets="props.tickets" :replies="ticket.replies" :users="props.users" :auth="props.auth" :alert="props.alert" />
    </div>
</template>
