                            ...
                            <div class="card mb-4">
                                <div class="col-sm-12 mt-3">
                                        ...
                                        <div class="submenu text-a-r collapse " :id="'CollapseExample'+props.tickets.id">
                                            ...
                                            <button  @click.prevent="submit(props.tickets.id)" :class="{ 'opacity-25': form.processing }" :disabled="form.processing" class="btn btn-primary me-4">
                                    ...
                                    <TicketReply  :tickets="props.tickets" :replies="props.tickets.replies" :users="props.users" :auth="props.auth" />
                                </div>
                        </div>
                </div>
            </form>
