                            ...
                            <div class="col-lg-12">
                                <section class="content-body p-xl-4">
                                    <div class="table-responsive">
                                        <div v-if="props.user.total > 0" class="table table-hover">
                                            <thead>
                                                <tr class="col">
                                            ...
                                            <tbody >
                                                ...
                                                <tr v-for="(use,index) in props.user.data" :key="index">
                                                    ...
                                                    <td >
                                                        <!-- <span v-if="use.session">{{ moment.unix(use.session.last_activity).locale("fa", fa).format('jYYYY/jM/jD HH:mm') }}</span> -->
                                                        
                                                        <span v-if="use.session" class="badge badge-pill badge-soft-success">آنلاین</span>
                                                        ...
                                                        <span v-else class="badge badge-pill badge-soft-danger">{{ use.status }}</span>
                                                    </td>
                                                    <td>
