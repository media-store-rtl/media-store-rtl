                                        ...
                                        <div class="row">
                                            ...
                                            <aside class="col-lg-4">
                                                <figure class="text-lg-center">
                                                    ...
                                                    <img v-if="props.user && props.user.identity && props.user.identity.file" :src="$page.props.ziggy.url+'/storage/'+ props.user.identity.file.url" alt="national code Photo" />
