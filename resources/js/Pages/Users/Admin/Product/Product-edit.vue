...
const form =  useForm({id:props.product.id,name:props.product.name,name_en:props.product.name_en,
    ...
    test:[] , sub_test:[],tag:props.product.tag,slug:props.product.slug
});
                    ...
                    child.routes.forEach(route => {
                        if (route.name == props.path)
                        {
                            if (child.sections.length > 0)
                            {
                                child.sections.forEach(section =>
                                {
                                    if(section.name == 'products' && menu.value[0].id !== child.id || section.name == 'forms' && menu.value[0].id !== child.id)
                                    {
                                        menu.value.push(child)
                                    }
                                });
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="mt-1 col-sm-12">
                                        <label for="product_name" class="form-label">تگ اسلاگ <span
                                                class="text-danger">*</span></label>
