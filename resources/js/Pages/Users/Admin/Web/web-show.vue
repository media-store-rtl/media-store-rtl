...
const form =  useForm({
    name:props.webDesign.name,name_en:props.webDesign.name_en,group:null,type:null,slug:props.webDesign.slug,
    category:null,id:props.webDesign.id,status:props.webDesign.status,price:props.webDesign.price,tag:props.webDesign.tag,
    text:props.webDesign.text,image:props.webDesign.image,basic:props.webDesign.basic,
    damage:props.webDesign.damage,rouzekari:props.webDesign.rouzekari,pages:props.webDesign.pages,
});
...
const submit = () =>{
    ...
    form.text == null && form.image == null,form.tag == null, form.basic == null , form.damage == null,form.rouzekari == null ,form.pages == null)
    {
        let text
