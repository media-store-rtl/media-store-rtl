                                        ...
                                        <div class="mt-4">
                                            ...
                                            <select class="form-select" v-model.lazy="form.parent_id">
                                                ...
                                                <option v-if="props.menus && props.menus.length > 0" v-for="menu,index in props.menus" :key="index" :value="menu.id">
                                                    <span style="vertical-align: inherit;">{{menu.name}}(<span style="vertical-align: inherit;" v-if="menu.sections" v-for="section,index in menu.sections" :key="index"> قسمت:{{ section.name }}</span>)</span>
                                                </option>
