...
// if (props.subs) {
//     form.items = props.subs.data.map(element => ({
//         sectionable_type: element.sectionable_type,
//         sectionable_id: element.sectionable_id,
//     }))
// }
const submitSub = () =>{
    // if( form.name == null)
    ...
    form.transform(data => ({
        ...data,
        items
    })).put(route('section.update', form.id))
};
                                ...
                                <div v-for="(item, index) in form.items" :key="index" class="row gx-2">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mt-4">
                                            ...
                                            <input
                                                v-model.lazy="item.sectionable_type"
                                                type="text"
                                                class="form-control"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mt-4">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <input
                                                    v-model.lazy="item.sectionable_id"
                                                    type="number"
                                                    class="form-control"
                                                    placeholder="آیدی"
                                                >
