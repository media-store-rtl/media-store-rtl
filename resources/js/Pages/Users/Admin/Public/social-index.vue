            ...
            <section class="content-main">
                <div class="row content-header">
                    <div class="d-flex col-sm-12 align-items-center">
                        ...
                        <div style="margin-right:auto; text-align:left;"><Link :href="route('socialAdmin.create')" class="btn btn-primary btn-sm rounded font-sm">ایجاد</Link>
                        </div>
                    </div>
                    <div class="col-sm-12">
                            ...
                            <div class="col-lg-9">
                                    <section class="content-body p-xl-4">
                                            <div class="table-responsive" v-if="props.socials.total > 0">
                                                <div v-if="props.socials.total > 0" class="table table-hover">
                                                    <thead>
                                                        <tr class="col">
                                                ...
                                                <div class="pagination-area mb-20 mt-20" v-if="props.socials && props.socials.total > 9">
                                                    <nav aria-label="Page navigation example">
                                                        <ul class="pagination justify-content-start">
                                                            <li class="page-item" :class="{ disabled: !props.socials.prev_page_url || props.socials.current_page === 1 }" >
                                                                <Link class="page-link" :href=" props.socials.prev_page_url && props.socials.current_page > 1 ? props.socials.prev_page_url : ''" preserve-scroll preserve-state :aria-disabled="props.socials.current_page === 1">
                                                                    <i class="material-icons md-chevron_right"></i>
                                                                </Link>
                                                            </li>
                                                            <li class="page-item" :class="{ active: props.socials.current_page === 1 }">
                                                                <Link class="page-link" :href="getPageUrl(props.socials.first_page_url, 1)" preserve-scroll preserve-state >1</Link>
                                                            </li>
                                                            <li class="page-item" v-if="props.socials.current_page > 4">
                                                                <span class="page-link dot">...</span>
                                                            </li>
                                                            <template v-for="i in 5" :key="i">
                                                                <li class="page-item" v-if=" props.socials.current_page - 3 + i > 1 && props.socials.current_page - 3 + i < props.socials.last_page" :class="{ active: props.socials.current_page === props.socials.current_page - 3 + i }">
                                                                    <Link class="page-link" :href="getPageUrl(props.socials.path, props.socials.current_page - 3 + i)" preserve-scroll preserve-state >
                                                                        {{ props.socials.current_page - 3 + i }}
                                                                    </Link>
                                                                </li>
                                                            </template>

                                                            <li class="page-item" v-if="props.socials.current_page < props.socials.last_page - 3">
                                                                <span class="page-link dot">...</span>
                                                            </li>
                                                            <li class="page-item" v-if="props.socials.last_page !== 1" :class="{ active: props.socials.current_page === props.socials.last_page }">
                                                                <Link class="page-link" :href="getPageUrl(props.socials.path, props.socials.last_page)" preserve-scroll preserve-state>
                                                                    {{ props.socials.last_page }}
                                                                </Link>
                                                            </li>
                                                            <li class="page-item" :class="{ disabled:!props.socials.next_page_url || props.socials.current_page === props.socials.last_page,}">
                                                                <Link class="page-link" :href="props.socials.next_page_url && props.socials.current_page < props.socials.last_page
                                                                            ? props.socials.next_page_url: ''"preserve-scroll preserve-state :aria-disabled="props.socials.current_page === props.socials.last_page">
