            ...
            <section class="content-main">
                <div class="row content-header">
                    <div class="d-flex col-sm-12 align-items-center">
                        ...
                        <div style="margin-right:auto; text-align:left;"><Link :href="route('installment.create')" class="btn btn-primary btn-sm rounded font-sm">ایجاد</Link>
                        </div>
                    </div>
                    <div class="col-sm-12">
                                        ...
                                        <div v-if="props.installments.total > 0" class="table table-hover">
                                            ...
                                            <tbody >
                                                <tr v-for="section in props.installments.data" :key="section.id">
                                                    ...
                                                    <td class="text-end">
                                                        <div class="dropdown">
                                                            <a href="#" @click.prevent.stop="toggleMenu(installment.id)" class="btn btn-light rounded btn-sm font-sm"> <i class="material-icons md-more_horiz"></i> </a>
                                                            <div v-if="openMenu === installment.id" class="dropdown-menu show" @click.stop>
