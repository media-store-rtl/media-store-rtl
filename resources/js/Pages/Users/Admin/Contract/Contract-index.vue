...
const props = defineProps({
    contracts:Object,users:Object,cart:Object,wallet:Number,notifications:Object,names:Object,ids:Object,statuses:Object,companies:Object,
        ...
        <section class="content-main">
            <div class="row content-header">
                ...
                <div class="col-sm-12">
                   ...
                   <div class="card mb-4"  v-if="props.contracts.total > 0">
                        <div class="card-body" v-if="props.contracts">
                            <div class="row gx-5">
                                <div class="col-lg-9">
                                    <section class="content-body p-xl-4">
                                        <div v-if="props.contracts.total > 0 " class="table-responsive">
                                            <div class="table table-hover">
                                                ...
                                                <tbody >
                                                    <tr v-for="(tarahi,index) in props.contracts.data" :key="index">
                                                        <td >{{(tarahi.id).toLocaleString("fa-IR")}}</td>
                                                        <td >{{tarahi.order_id}}</td>
                                                        <td v-if="tarahi.user">
                                                            <Link  :href="route('profile.show',[tarahi.user.user_name])"> {{tarahi.user.name + '' + tarahi.user.lasst_name}}</Link>
                                                        </td>
                                                        <td>
                                                            {{ tarahi.plan.name }}
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span v-if="tarahi.status == 4" class="badge badge-pill badge-soft-success">تایید</span>
                                                        ...
                                                        <td class="text-end">
                                                            <div class="dropdown" v-if="tarahi.status !== 3">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <Link class="dropdown-item" :href="route('contractAdmin.show',[tarahi.id])">نمایش</Link>
                                        ...
                                        <div class="mt-5" v-if="props.contracts.total > 9">
                                            <nav aria-label="Page navigation example">
                                                <ul class="pagination justify-content-start">
                                                    <li :class="['page-item',link.url == null ? 'disable' :'',link.active ? 'active' : '']"
                                                    v-for="link in props.contracts.links" :key="link.id" >
