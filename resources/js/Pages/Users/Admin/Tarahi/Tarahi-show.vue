...
const form = useForm({
    ...
    status:props.tarahis.status,entekhab:props.tarahis.company_id,slug:props.tarahis.slug
});
                        ...
                        <div class="card-body">
                            ...
                            <div class="row gx-2">
                                <div class="col-lg-6 mt-4">
                                    ...
                                    <div class="row gx-2" v-if="props.tarahis.user_canceller">
                                        {{ props.tarahis.user_canceller.user_name}}
                                    </div>
                            ...
                            <div class="row gx-2">
                                ...
                                <div class="col-lg-6 mt-4">
                                    ...
                                    <p v-if="form.total !== null">{{(form.total).toLocaleString("fa-IR")}}</p>
                                    <p v-else>تعیین نشده</p>
                                </div>
                            </div>
                            <div class="row gx-2">
                            ...
                            <div class="mt-4">
                                ...
                                <input v-model.lazy.trim="form.slug" type="text" placeholder="اینجا تایپ کنید"
