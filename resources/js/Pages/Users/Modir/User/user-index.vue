                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div class="table table-hover">
                                <thead>
                                    <tr>
                                        <th><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">کاربر</span></span></th>
                                        <th><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">نقش</span></span></th>
                                        <th><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">افتتاح حساب</span></span></th>
                                        <th><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">آخرین ورود</span></span></th>
                                        <th><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">وضعیت</span></span></th>
                                        <th class="text-end"><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">عملیات</span></span></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr v-for="(use,index) in props.user.data" :key="index">
                                        <td width="40%">
                                            <a href="#" class="itemside">
                                                ...
                                                <div class="info pl-3">
                                                    <h6 class="mb-0 title"><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">{{ use.user_name }}</span></span></h6>
                                                    <small class="text-muted"><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">شناسه کاربری: {{use.id}}</span></span></small>
                                                </div>
                                            </a>
                                        </td>
                                        <td >
                                            <template v-for="(role,index) in use.roles" :key="index"  class="d-flex" >
                                                <span style="vertical-align: inherit;" ><span style="vertical-align: inherit;"> {{ role.name + ' ' }}</span></span>
                                            </template>
                                        </td>
                                        <td><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">{{ moment(use.created_at).locale("fa", fa).format('jYYYY/jM/jD HH:mm') }}</span></span></td>
                                        <td><span style="vertical-align: inherit;"><span style="vertical-align: inherit;">{{ moment(use.updated_at).locale("fa", fa).format('jYYYY/jM/jD HH:mm') }}</span></span></td>
                                        <td>
