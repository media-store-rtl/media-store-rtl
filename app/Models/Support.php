...
class Support extends Model
{
    ...
    {
        return $this->hasMany(Support::class, 'parent_id')->with('replies')->with('subject')->with('recepiant')->with('supportables')->with('user')->with('file');
    }
    ...
    {
        return $this->hasOne(Support::class, 'parent_id')->latest('created_at');
    }
