...
class TermsSellerController extends Controller
{
    /**
    ...
    public function index(Request $request,Page $page,User $user,Route $route,Social $social,Namad $namad)
    {
        ...
        $pages = $page->where('route','terms-seller')->with('user')->first();
        ...
        return  $pages ? Inertia::render('Guest/Terms-Seller',['companies' => $companies,'pages'=>$pages,
