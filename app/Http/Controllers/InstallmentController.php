...
class InstallmentController extends Controller
{
    ...
    public function show(Request $request,User $user,Installment $installment,Company $company,Route $route,Installmentable $sub)
    {
        ...
        $companies = $user->with('image')->first();
        $descriptions = $route->where('name','route(installment.show)')->first() && $route->where('name','route(installment.show)')->first()->descriptions?
            $route->where('name','route(installment.show)')->first()->descriptions->first():null;
        $wallet = Wallet::all($users);
