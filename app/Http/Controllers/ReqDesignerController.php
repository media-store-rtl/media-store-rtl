...
class ReqDesignerController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request,Tarahi $tarahi,ReqDesigner $reqdesigner,User $user,Company $company)
    {
                            ...
                            if($tarahis)
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        TarahiReqJob::dispatch($tarahis,$message)->delay(now()->addMinute((int)$companies->job));
