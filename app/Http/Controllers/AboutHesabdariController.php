...
class AboutHesabdariController extends Controller
{
    /**
    ...
    public function index(Request $request,User $user,Social $social,Route $route,Namad $namad)
    {
        ...
        // dd($request,$socials);
        return Inertia::render('Guest/about-hesabdari',['time' => $time, 'menus' => $menus, 'menu' => $menu,'companies'=>$companies,'socials'=> $socials,'path' => $request->path(),
        'namads'=> $namads]);
