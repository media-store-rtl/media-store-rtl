...
class ReqTarahiController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(ReqDesigner $reqDesigner,Request $request,Tarahi $tarahi,User $user,Company $company,Route $route,$id)
    {
        ...
        return Inertia::render('Users/Buyer/Tarahi/Req-Tarahi-show',['tarahi'=> $tarahis,'users' => $users,'names'=> $names,'ids'=> $ids,'statuses'=> $statuses,'token'=>$token,
        'notifications'=> $notifications,'companies'=>$companies,'descriptions'=>$descriptions,'reqDesigners'=>$reqDesigners,'alert'=> $alert,'wallet'=>$wallet,
