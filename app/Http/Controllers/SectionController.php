...
class SectionController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request,User $user,Section $section,Company $company,Route $route,Sectionable $sub,$id)
    {
        // Gate::authorize('create',$section);
        ...
        $subs = $sub->where('section_id',$id)->orderBy('created_at','desc')->paginate(9);
        $companies = $user->with('image')->first();
