...
class ProfileAdminController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request,User $user,Profile $profile,Image $image,Company $company)
    {
        Gate::authorize('create', $user);
        ...
        if($request->image)
        {
            ...
            if($profiles)
            {
                ...
                ProfileAdminJob::dispatch($profiles)->delay(now()->addMinute((int)$companies->job));
